...
export default function useMarkedLightPillar(options) {
     ...
     */
        ...
        // TODO 改变光柱硬度
    const createLightPillar = (lon, lat, heightScaleFactor = 1, label = "joji") => {
            ...
            tag.className = 'tag-description';
            tag.textContent = label;
            tag.style.pointerEvents = 'none';
            let css2DDescription = new CSS2DObject(tag);
            css2DDescription.position.set(0, 0, heightScaleFactor + 0.2)
            light01.add(css2DDescription);
