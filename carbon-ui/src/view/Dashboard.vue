...
const carbonYears = [{label: '2020', value: '2020'}, {label: '2015', value: '2015'},
  {label: '2010', value: '2010'}, {label: '2005', value: '2005'}]

let baseEarth = reactive({});
    ...
    initModel() {
      try {
        ...
        provinceData.features.forEach((elem, index) => {
          ...
          // 记录索引
          provinceIndex[province.name] = 2*index+1;
          // 创建标点和标签
